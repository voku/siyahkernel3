...
ARM_FLAGS       = -marm -march=armv7-a -mtune=cortex-a9 -mfpu=neon -mfloat-abi=softfp -fsingle-precision-constant -mvectorize-with-neon-quad
LOOPS		= -funswitch-loops -fpredictive-commoning -floop-interchange -floop-strip-mine -floop-block
