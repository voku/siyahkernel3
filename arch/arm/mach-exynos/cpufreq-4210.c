...
static unsigned int clkdiv_cpu0[CPUFREQ_LEVEL_END][7] = {
	...
	{ 0, 3, 7, 3, 4, 1, 7 },  /* ARM L5: 1150MHz */
	{ 0, 3, 7, 3, 4, 1, 7 },  /* ARM L6: 1100MHz */
	{ 0, 3, 7, 3, 4, 1, 7 },  /* ARM L7: 1050MHz */
	{ 0, 3, 7, 3, 4, 1, 7 },  /* ARM L8: 1000MHz */
	{ 0, 3, 7, 3, 4, 1, 7 },  /* ARM L9:  950MHz */
	{ 0, 3, 7, 3, 4, 1, 7 },  /* ARM L7:  900MHz */
	{ 0, 3, 7, 3, 3, 1, 7 },  /* ARM L11: 850MHz */
	...
	{ 0, 1, 3, 1, 3, 1, 7 },  /* ARM L27: 50MHz */
	{ 0, 1, 3, 1, 3, 1, 7 },  /* ARM L28: 25MHz */
};
...
static unsigned int exynos4_apll_pms_table[CPUFREQ_LEVEL_END] = {
	...
	((144 << 16)|(3 << 8)|(0x1)),	/* APLL FOUT L4: 1150MHz */	 // 287.5 // 143.75
	((275 << 16)|(6 << 8)|(0x1)),	/* APLL FOUT L6: 1100MHz */
	((263 << 16)|(6 << 8)|(0x1)),	/* APLL FOUT L6: 1050MHz */	 // 262.5
	((250 << 16)|(6 << 8)|(0x1)),	/* APLL FOUT L8: 1000MHz */
	((238 << 16)|(6 << 8)|(0x1)),	/* APLL FOUT L10: 950MHz */	 // 237.5
	((225 << 16)|(6 << 8)|(0x1)),	/* APLL FOUT L10: 900MHz */
	((213 << 16)|(6 << 8)|(0x1)),	/* APLL FOUT L11: 850MHz */  // 212.5
	...
	((100 << 16)|(6 << 8)|(0x4)),	/* APLL FOUT L27: 50MHz */
	((50 << 16)|(6 << 8)|(0x4)),	/* APLL FOUT L28: 25MHz */		//(0x4=16) (0x3=8) (0x2=4) (0x1=2)  (6<<8=2) (3<<8=1)
};
...
static const unsigned int asv_voltage_A[CPUFREQ_LEVEL_END][8] = {
	...
	{ 1325000, 1325000, 1275000, 1275000, 1225000, 1200000, 1175000, 1150000 }, //1150MHz
	{ 1325000, 1325000, 1250000, 1250000, 1200000, 1175000, 1150000, 1125000 }, //1100MHz
	{ 1300000, 1300000, 1225000, 1225000, 1175000, 1150000, 1125000, 1100000 }, //1050MHz
	{ 1300000, 1250000, 1200000, 1200000, 1150000, 1125000, 1100000, 1075000 }, //1000MHz
	{ 1275000, 1225000, 1175000, 1150000, 1125000, 1100000, 1075000, 1050000 }, // 950MHz
	{ 1250000, 1200000, 1150000, 1125000, 1100000, 1075000, 1050000, 1025000 }, // 900MHz
	{ 1225000, 1175000, 1125000, 1100000, 1075000, 1050000, 1025000, 1000000 }, // 850MHz
	{ 1200000, 1150000, 1100000, 1075000, 1050000, 1025000, 1000000,  975000 }, // 800MHz
	{ 1175000, 1125000, 1100000, 1050000, 1050000, 1025000, 1000000,  975000 }, // 750MHz
