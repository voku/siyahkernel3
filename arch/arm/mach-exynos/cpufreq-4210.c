...
static unsigned int clkdiv_cpu0[CPUFREQ_LEVEL_END][7] = {
	...
	{ 0, 3, 7, 3, 4, 1, 7 },  /* ARM L5: 1152MHz */
	{ 0, 3, 7, 3, 4, 1, 7 },  /* ARM L6: 1100MHz */
	{ 0, 3, 7, 3, 4, 1, 7 },  /* ARM L7: 1052MHz */
	{ 0, 3, 7, 3, 4, 1, 7 },  /* ARM L8: 1000MHz */
	{ 0, 3, 7, 3, 4, 1, 7 },  /* ARM L9:  952MHz */
	{ 0, 3, 7, 3, 4, 1, 7 },  /* ARM L10: 900MHz */
	{ 0, 3, 7, 3, 3, 1, 7 },  /* ARM L11: 852MHz */
	{ 0, 3, 7, 3, 3, 1, 7 },  /* ARM L12: 800MHz */
	{ 0, 3, 7, 3, 3, 1, 7 },  /* ARM L13: 750MHz */
	{ 0, 3, 7, 3, 3, 1, 7 },  /* ARM L14: 700MHz */
	{ 0, 3, 7, 3, 3, 1, 7 },  /* ARM L15: 650MHz */
	{ 0, 3, 7, 3, 3, 1, 7 },  /* ARM L16: 600MHz */
	{ 0, 3, 7, 3, 3, 1, 7 },  /* ARM L17: 550MHz */
	{ 0, 3, 7, 3, 3, 1, 7 },  /* ARM L18: 500MHz */
	{ 0, 3, 7, 3, 3, 1, 7 },  /* ARM L19: 450MHz */
	{ 0, 3, 7, 3, 3, 1, 7 },  /* ARM L20: 400MHz */
	{ 0, 3, 7, 3, 3, 1, 7 },  /* ARM L21: 350MHz */
	{ 0, 3, 7, 3, 3, 1, 7 },  /* ARM L22: 300MHz */
	{ 0, 3, 7, 3, 3, 1, 7 },  /* ARM L23: 250MHz */
	{ 0, 1, 3, 1, 3, 1, 7 },  /* ARM L24: 200MHz */
	{ 0, 1, 3, 1, 3, 1, 7 },  /* ARM L25: 150MHz */
	{ 0, 1, 3, 1, 3, 1, 7 },  /* ARM L26: 100MHz */
};
...
static unsigned int exynos4_apll_pms_table[CPUFREQ_LEVEL_END] = {
	...
	((325 << 16)|(6 << 8)|(0x2)),	/* APLL FOUT L15: 650MHz */
	((300 << 16)|(6 << 8)|(0x2)),	/* APLL FOUT L16: 600MHz */
	((275 << 16)|(6 << 8)|(0x2)),	/* APLL FOUT L17: 550MHz */
	((250 << 16)|(6 << 8)|(0x2)),	/* APLL FOUT L18: 500MHz */
	((225 << 16)|(6 << 8)|(0x2)),	/* APLL FOUT L19: 450MHz */
	((200 << 16)|(6 << 8)|(0x2)),	/* APLL FOUT L20: 400MHz */
	((175 << 16)|(6 << 8)|(0x2)),	/* APLL FOUT L21: 350MHz */
	((300 << 16)|(6 << 8)|(0x3)),	/* APLL FOUT L22: 300MHz */
	((250 << 16)|(6 << 8)|(0x3)),	/* APLL FOUT L23: 250MHz */
...
static const unsigned int asv_voltage_A[CPUFREQ_LEVEL_END][8] = {
	...
	{ 1350000, 1350000, 1300000, 1250000, 1250000, 1225000, 1200000, 1175000 }, //1200MHz
	{ 1325000, 1325000, 1275000, 1200000, 1225000, 1200000, 1175000, 1150000 }, //1152MHz
	{ 1325000, 1325000, 1250000, 1200000, 1200000, 1175000, 1150000, 1125000 }, //1100MHz
	{ 1300000, 1300000, 1225000, 1150000, 1175000, 1150000, 1125000, 1100000 }, //1052MHz
	{ 1300000, 1250000, 1200000, 1150000, 1150000, 1125000, 1100000, 1075000 }, //1000MHz
	{ 1275000, 1225000, 1175000, 1100000, 1125000, 1100000, 1075000, 1050000 }, // 952MHz
	{ 1250000, 1200000, 1150000, 1100000, 1100000, 1075000, 1050000, 1025000 }, // 900MHz
	{ 1225000, 1175000, 1125000, 1050000, 1075000, 1050000, 1025000, 1000000 }, // 852MHz
	{ 1200000, 1150000, 1100000, 1050000, 1050000, 1025000, 1000000,  975000 }, // 800MHz
	{ 1175000, 1125000, 1100000, 1025000, 1050000, 1025000, 1000000,  975000 }, // 750MHz
	{ 1150000, 1100000, 1075000, 1025000, 1025000, 1000000,  975000,  950000 }, // 700MHz
	{ 1125000, 1075000, 1050000, 1000000, 1000000,  975000,  950000,  950000 }, // 650MHz
	{ 1125000, 1075000, 1025000, 1000000, 1000000,  975000,  950000,  950000 }, // 600MHz
	{ 1100000, 1050000, 1000000,  975000,  975000,  975000,  950000,  950000 }, // 550MHz
	{ 1100000, 1050000, 1000000,  975000,  975000,  950000,  925000,  925000 }, // 500MHz
	{ 1075000, 1025000, 1000000,  975000,  975000,  950000,  925000,  925000 }, // 450MHz
	{ 1075000, 1025000, 1000000,  975000,  975000,  950000,  925000,  925000 }, // 400MHz
	{ 1075000, 1025000, 1000000,  975000,  975000,  950000,  925000,  925000 }, // 350MHz
	{ 1075000, 1025000, 1000000,  975000,  975000,  950000,  925000,  925000 }, // 300MHz
	{ 1050000, 1000000,  975000,  950000,  950000,  925000,  925000,  925000 }, // 250MHz
	{ 1050000, 1000000,  975000,  950000,  950000,  925000,  925000,  925000 }, // 200MHz
	{ 1050000, 1000000,  975000,  925000,  950000,  925000,  925000,  925000 }, // 150MHz
